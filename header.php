...
<head>
  ...
  <link href="<?php echo get_bloginfo('stylesheet_directory') . '/app.css?' . filemtime( get_stylesheet_directory() . '/app.css'); ?>" rel="stylesheet" type="text/css">
  ...
  <script src="<?php echo get_bloginfo('template_directory') . '/js/min/app.js?' . filemtime( get_template_directory() . '/js/min/app.js'); ?>" type="text/javacript"></script>

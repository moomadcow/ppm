...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php bloginfo('template_url'); ?>/images/android-chrome-192x192.png" sizes="192x192">
  ...
  <meta name="msapplication-TileColor" content="#4b0735">
  ...
  <link href="<?php bloginfo('stylesheet_directory'); ?>/app.css?version=1.0.0" rel="stylesheet" type="text/css">
  <script src="<?php bloginfo('template_url'); ?>/js/vendor/modernizr-2.8.3.js" type="text/javascript"></script>
  <script src="<?php bloginfo('template_url'); ?>/js/vendor/jquery-2.1.4.min.js" type="text/javascript"></script>
  <script src="<?php bloginfo('template_url'); ?>/js/vendor/js.cookie.js" type="text/javascript"></script><?php wp_head(); ?>
  <script src="<?php bloginfo('template_url'); ?>/js/min/app.js?version=1.0.0" type="text/javascript"></script>
